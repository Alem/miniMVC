...
class Controller{
	...
	// $eponym: If set to true, uses name of model to assign model as property.
	...
	// $assign: If set to true, will assign the module as a property of the controller that called it.
	...
	// $controller - The controller the method belongs to. Defaults to the current controller if $method is specified.
