...
class Processor{
	...
	public function loadCoreConfig()
	{
		...
		elseif( isset( $this->args['a'] ) && ( isset( $this->args['useconfig'] ) || isset( $this->args['u'] ) ) )
		{
	...
	OPTIONS
		...
		--useconfig   [PATH]	Use application configuration file.
			or -u [PATH]	If the application does not follow typical conventions, --useconfig can be used to manually set the path.
