...
class Controller
{
	...
	/**
	 * @var string The name of the Controller object's unit and controller. ( Lowercase, no suffix )
	 *
	...
	/**
	 * @var string Holds data related to loaded resources.(i.e. objects of Model, paths of Views)
	 */
	public $loaded = array();
